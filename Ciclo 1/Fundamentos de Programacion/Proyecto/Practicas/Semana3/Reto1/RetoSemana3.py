...
def solucion():
    ...
    indicando cuantas posiciones son usadas (En este caso es igual al tamaño del vector)"""
    vec_org18.V[0] = n
    print('Vector original con posiciones usadas:', vec_org18)
    ...
    indicando cuantas posiciones son usadas(En este caso es igual al tamaño del vector)'''
    vec_mod18.V[0] = n
    print('\nVector copy con posiciones usadas:', vec_mod18)
