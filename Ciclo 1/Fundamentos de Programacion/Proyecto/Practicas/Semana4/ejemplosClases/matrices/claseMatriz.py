...
class matriz:
    ...
    def mostrarDiagonal(self):
        #Toma los datos del triangular superior de la diagonal secundaria y almacena el mayor dato en un vector
        v = vector(50)
        may = 0
        for i in range(1, self.m + 1):
